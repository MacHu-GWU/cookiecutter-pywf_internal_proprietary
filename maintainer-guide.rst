...
前置条件
------------------------------------------------------------------------------
- 当 `cookiecutter_pywf_internal_proprietary_demo-project <https://github.com/MacHu-GWU/cookiecutter_pywf_internal_proprietary_demo-project>`_ 趋于稳定之后再来修改此项目模板
- 当模板用到了 ``pywf_internal_proprietary`` 中的新功能时, 要先发布 `pywf_internal_proprietary-project <https://github.com/MacHu-GWU/pywf_internal_proprietary-project>`_ 再来修改此项目模板
...
1. **在 Seed 项目中进行修改**
   ...
   所有功能性的修改都应该在 Seed 项目 (``$HOME/GitHub/cookiecutter_pywf_internal_proprietary_demo-project``) 中完成并测试
...
技术架构
------------------------------------------------------------------------------
- **Template Repository**: ``cookiecutter-pywf_internal_proprietary`` (当前仓库)
- **Seed Repository**: ``cookiecutter_pywf_internal_proprietary_demo-project``
