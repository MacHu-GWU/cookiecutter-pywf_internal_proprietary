...
"""
Deploy the latest documentation to AWS S3.

Uploads docs/build/html to:
  s3://{bucket}/projects/{package_name}/latest/
...
def main():
    ...
    s3_uri = f"s3://{bucket}/{S3_PREFIX}{package_name}/latest/"

    print(f"Deploying latest documentation to S3...")
    ...
    try:
        ...
        print(f"✅ Deployed latest doc to {s3_uri}")
